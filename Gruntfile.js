...
//                tasks: ['newer:jshint:test', 'karma']
        ...
        concat: {
            ...
            dist: {
                src: [
                    '<%= config.src %>/*.js',
                    '.tmp/ap-offline-generator-templates.js'
                ],
                dest: '<%= config.dist %>/ap-offline-generator.js'
            }
        },
        ...
        ngAnnotate: {
            dist: {
                files: [
                    {
                        src: '<%= config.dist %>/ap-offline-generator.js'
                    }
                ]
            }
        },
        ...
        uglify: {
            js: {
                src: ['<%= config.dist %>/ap-offline-generator.js'],
                dest: '<%= config.dist %>/ap-offline-generator.min.js'
            }
        },
...
//                startPage: '/api',
                title: 'Angular-Point-Offline-Generator Docs'
            },
            api: {
                src: [
                    '<%= config.src %>/*.js'
                ],
                title: 'Offline Generator Documentation',
                api: false
            }
        },
        'gh-pages': {
        ...
        copy: {
            demo: {
                src: '<%= config.dist %>/*.js',
                dest: '<%= config.demo %>/bower_components/angular-point-offline-generator/'
            }
        }
